...
char* matakuliah()
{
 char* z,v;
   if(rs.kmk == 151)
    {z = "Algoritma Pemrograman";}
   else if(rs.kmk == 422)
    {z = "Arsitektur Komputer";}
   else if(rs.kmk == 733)
    {z = "Pemrograman Web";}
   else if(rs.kmk == 772)
    {z = "Akhlak";}
...
char* dosen()
{
 char* v;
   if(rs.kmk == 151)
    {v = "Dr.Ir.Ardi Pujiyanta,M.T.";}
   else if(rs.kmk == 422)
    {v = "Bambang Robiin,S.T.,M.T.";}
   else if(rs.kmk == 733)
    {v = "Ali Tarmuji,S.T.,M.Cs.";}
   else if(rs.kmk == 772)
    {v = "Nayif Fairuza,S.Hum.,M.A.";}
   return v;
}
float total(int a)
{
...
int main(void)
{
   ...
   cout<<"Dosen Pengampu   : "<<dosen()<<endl;
   cout<<"==========================================================================="<<endl;
